...
export function IconEdit({ size = 24, color = '#111827' }: IconProps): React.JSX.Element {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M19.5606 4.43934C18.9748 3.85355 18.0251 3.85355 17.4393 4.43934L16.6464 5.23223L18.7677 7.35355L19.5606 6.56066C20.1464 5.97487 20.1464 5.02513 19.5606 4.43934ZM20.9748 7.97487C22.3417 6.60804 22.3417 4.39196 20.9748 3.02513C19.608 1.65829 17.3919 1.65829 16.0251 3.02513L14.5253 4.52494L2.29289 16.7573C2.10536 16.9448 2 17.1992 2 17.4644V21.0355C2 21.5878 2.44772 22.0355 3 22.0355H6.5C6.76522 22.0355 7.01957 21.9301 7.20711 21.7426L20.9748 7.97487ZM17.3535 8.76777L15.2322 6.64645L4 17.8786V20.0355H6.08579L17.3535 8.76777Z"
        fill={color}
      />
    </Svg>
  );
...
export function IconLocationMarker({ selected = false }: LocationMarkerProps): React.JSX.Element {
  const fill = selected ? '#264BEB' : '#8DA0F0';
  return (
    <Svg width={30} height={40} viewBox="0 0 30 40" fill="none">
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15 40C15 40 30 23.5195 30 15.1515C30 6.78356 23.2843 0 15 0C6.71573 0 0 6.78356 0 15.1515C0 23.5195 15 40 15 40ZM15 14.5455C17.1539 14.5455 18.9 12.7817 18.9 10.6061C18.9 8.43039 17.1539 6.66667 15 6.66667C12.8461 6.66667 11.1 8.43039 11.1 10.6061C11.1 12.7817 12.8461 14.5455 15 14.5455Z"
        fill={fill}
      />
    </Svg>
  );
